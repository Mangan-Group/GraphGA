...
if __name__ == "__main__":
    ...
    # results_path = "Amp_seed_pop_vary_dose/2024-03-08_Amplifier_pop_vary_dose_new_dose_terms_seed_0/"
    # get_single_obj_selected_results(repo_path, results_path, [62.5], "high_ON_rel", False)
    # results_path = "SC_seed_pop_DsRED_inhibitor/2024-03-06_Signal_Cond_pop_DsRED_inhibitor_ngen80_new_dose_terms_seed_0/"
    # results_path = "Pulse_seed_pop_DsRED_inhibitor/2024-03-07_Pulse_pop_DsRED_inhibitor_t_pulse_126h_ngen80_new_dose_terms_seed_0/"
    results_path = "Pulse_seed_pop_DsRED_inhibitor/ZF1_ZF2_only/2024-03-07_Pulse_pop_DsRED_inhibitor_t_pulse_126h_ZF1_ZF2_new_dose_terms_seed_0/"
    # (
    #     settings,
    #     pareto_unique_obj, 
    #     pareto_unique_circuits
    # ) = import_multi_obj_GA_files(repo_path, results_path)

    # # print(pareto_unique_obj)
    # selected_results_df = get_multi_obj_selected_results(settings, pareto_unique_obj, pareto_unique_circuits, {"t_pulse": [0.0, 24.0]})
    # all_cell_results_df = get_selected_all_cell_metrics(settings, selected_results_df)
    # # print(all_cell_results_df)
    # plot_all_cell_objs("", settings, all_cell_results_df)
