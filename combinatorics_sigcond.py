...
with open("./combo_search/settings_sigcond.json", "r") as fid:
...
with open('./combo_search/sigcond/sigcond_topo_2_inhibitor_p%d.pkl'%index, 'wb') as fid:
    pickle.dump(combo_expanded, fid)
with open('./combo_search/sigcond/sigcond_obj_2_inhibitor_p%d.pkl'%index, 'wb') as fid:
    pickle.dump(obj, fid)
