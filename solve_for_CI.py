...
path_amp_const_obj = "/Users/kdreyer/Documents/Github/GraphGA/GA_results/Amp_seed_pop_vary_dose/2023-10-31_Amplifier_pop_vary_dose_seed_0/unique_objectives.pkl"
path_amp_const_circuits = "/Users/kdreyer/Documents/Github/GraphGA/GA_results/Amp_seed_pop_vary_dose/2023-10-31_Amplifier_pop_vary_dose_seed_0/unique_circuits.pkl"
with open(path_amp_const_obj, "rb") as fid:
    unique_obj = pickle.load(fid)
...
index_unique_obj_high = np.argwhere(unique_obj >= 68)
# print(index_unique_obj_high)
unique_obj_high = unique_obj[index_unique_obj_high.flatten()]
unique_circuits_high = unique_circuits[index_unique_obj_high.flatten()]
# print(unique_circuits_high)
...
# plot_1D_obj_scatter_for_ci(path_before_ci, all_obj, "ON_rel", y_lower_lim=67)
