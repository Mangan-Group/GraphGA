...
def simulate_cell(topology, Z_list, max_time=42):
    ...
    rep_off_end = odeint(system_equations_DsRed_pop, np.zeros(topology.num_states * 2), t, args=('off', Z_list, topology,))[-1, -1]
    rep_on_ts = odeint(system_equations_DsRed_pop, np.zeros(topology.num_states * 2), t, args=('on', Z_list, topology,))[:, -1]
...
if __name__ == '__main__':
    ...
    topology = Topo([('P1', 'Z2'), ('P1', 'I2'), ('Z2', 'Rep'), ('I2', 'Rep')], {'Z2': 75, 'I2': 10}, 'P1')
    rep_off_mean, rep_on_mean, rep_on_ts_mean = simulate_pop(topology, [[1, 1, 1, 1, 1]], 8, 42)

    print(rep_off_mean)
    print(rep_on_mean)
#     # print(rep_on_ts_mean)
    
# print((3225.57623824571-3180.001662045868)/3180.001662045868 *100)