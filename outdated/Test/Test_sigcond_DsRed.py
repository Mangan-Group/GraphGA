...
def simulate(topology, max_time=48):
    ...
    rep_off = odeint(system_equations_DsRed, np.zeros(topology.num_states * 2), t, args=('off', topology,))[-1, -1]
    rep_on = odeint(system_equations_DsRed, np.zeros(topology.num_states * 2), t, args=('on', topology,))[-1, -1]
